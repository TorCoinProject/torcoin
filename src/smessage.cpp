// Copyright (c) 2014 The Torcoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("torcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("torcoin-smsg-pow"); // Make this thread recognisable
